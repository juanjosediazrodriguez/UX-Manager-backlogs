...
if USE_SQLITE_FOR_TESTS:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("MYSQL_DATABASE", default="uxmanager"),
...
# Caches (Redis recommended; fallback to local-memory). Force LocMem during tests.
IS_TESTING = "PYTEST_CURRENT_TEST" in os.environ
REDIS_URL = env("REDIS_URL", default=None)
# Use Redis only when explicitly configured and not testing/SQLite-tests
...
SESSION_COOKIE_AGE = 60 * 60 * 24 * 30  # 30 days persistent sessions
CSRF_TRUSTED_ORIGINS = env.list("CSRF_TRUSTED_ORIGINS", default=[])

# Logging (compact; can be expanded later)
LOGGING = {
    "version": 1,
